...
const colors = isDarkMode
  ? {
      totalSales: { stroke: "#5e5b78", fill: "#69669e" },
      extrasSales: { stroke: "#22c55e", fill: "#22c55e" },
      text: "#e5e7eb",
      background: "#18212f",
    }
  : {
      totalSales: { stroke: "#2f2d56", fill: "#1a2967" },
  ...
  return(
    <StyledSalesChart>
      ...
      <CartesianGrid/>
      <Tooltip/>
      <Area name="Total Sales" unit="$" dataKey="totalSales" type="monotone" stroke={colors.totalSales.stroke} fill={colors.totalSales.fill}/>
      <Area name="Extras Sales" unit="$" dataKey="extrasSales" type="monotone" stroke={colors.extrasSales.stroke} fill={colors.extrasSales.fill}/>
